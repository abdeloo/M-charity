...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>SADAKA | Projets à venir </title>
              ...
              <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse pull-right">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="has-child"><a href="#">ADHERATION</a>                    
                    @guest
                    <ul class="submenu">
                      @if (Route::has('login'))
	...
	<div class="page-heading text-center">
		...
		<div class="container zoomIn animated">
			...
			<h1 class="page-title">Les projets à venir <span class="title-under"></span></h1>
			<p class="page-description">
                      <p><a href="index">Accueil</a> / Les projets à venir  </p>  
			</p>
	...
	<div class="main-container">
		...
		<div class="our-causes fadeIn animated">
	        ...
	        <div class="container">
	            ...
	            <h2 class="title-style-1">Nos projets à venir <span class="title-under"></span></h2>
		                ...
		                <div class="col-md-3 col-sm-6">
		                    ...
		                    <div class="cause">
		                        ...
		                        <div class="text-center1">
                                  ...
                                  <button type="button" class="btn btn-success">{{ $project['location'] }}</button> 
		                          <button type="button" class="btn btn-success">{{ $project['action_date'] }}</button>
                            ...
                            <div class="footer-content">
                                ...
                                @csrf 
                                        ...
                                        <div class="form-group alerts">
                                         ...
                                         <div class="form-group">
                                            <button type="submit" class="btn btn-submit pull-right">Envoyez Messagae</button>
                                        </div>
